...
<div class="card card-default">
  ...
  <tr>
    ...
    <td> 
      @if ($siswa->foto)
      <img style="max-width:100px; max-height:100px" src="{{url('foto'). '/' .$siswa->foto}}">
      @endif
    </td>
    <td>{{$siswa->nama}}</td>
    <td>{{$siswa->kelas}}</td>
    ...
    <td>
    <a href="{{route('siswa.input')}}" class="d-none d-sm-inline-block btn btn-sm btn-primary">Input</a> 
